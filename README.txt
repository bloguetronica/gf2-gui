This package contains all the necessary files and scripts to install GF2 GUI
(which is a graphical user interface that invokes commands to control the GF2
